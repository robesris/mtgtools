      ...
      <head>
        ...
        <style>
          ...
          .color-filter-tray {
            ...
            max-width: 240px; /* Prevent growing */
            background: white;
            border-radius: 8px;
          ...
          .color-filter-tray.collapsed {
            width: 30px; /* Fixed width when collapsed */
            min-width: 30px;
            max-width: 30px;
            transform: translateX(0); /* Remove transform, use width instead */
            padding: 15px 5px; /* Reduce padding when collapsed */
          }
